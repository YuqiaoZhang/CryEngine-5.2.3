...
void CInputExtension::Release()
{
	...
	gEnv->pConsole->UnregisterVariable("game_mouse_sensitivity", true);
	gEnv->pConsole->UnregisterVariable("game_controller_sensitivity", true);
...
void CInputExtension::PostInit(IGameObject* pGameObject)
{
	...
	REGISTER_CVAR2("game_mouse_sensitivity", &m_mouseSensitivity, 0.002f, VF_NULL, "Mouse Sensitivity.");
	REGISTER_CVAR2("game_controller_sensitivity", &m_controllerSensitivity, 0.03f, VF_NULL, "Controller Sensitivity.");
}
