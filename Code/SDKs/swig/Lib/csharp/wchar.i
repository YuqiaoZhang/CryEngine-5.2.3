...
%pragma(csharp) imclasscode=%{
  protected class $outPrefixSWIGWStringHelper {
    ...
    static $outPrefixSWIGWStringHelper() {
      SWIGRegisterWStringCallback_$module(wstringDelegate);
    }
  }

  static protected $outPrefixSWIGWStringHelper swigWStringHelper = new $outPrefixSWIGWStringHelper();
%}
